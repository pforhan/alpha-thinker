...
class ThinkerRepository(
    ...
    fun updateAnswer(projectId: String, questionId: String, text: String, isDraft: Boolean, onResult: (Result<Unit>) -> Unit) {
        CoroutineScope(Dispatchers.Default).launch {
            try {
    ...
    fun deleteAnswer(projectId: String, questionId: String, answerId: Long, onResult: (Result<Unit>) -> Unit) {
        CoroutineScope(Dispatchers.Default).launch {
            try {
    ...
    fun updateProject(id: String, title: String, synopsis: String, mode: ProjectUpdateMode, onResult: (Result<Project?>) -> Unit) {
        CoroutineScope(Dispatchers.Default).launch {
            try {
